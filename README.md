...
# Instructions
$ javac -d \"build\" -cp \".:lib/jung/algos.jar:lib/jung/api.jar:lib/jung/collections.jar:lib/jung/graph_api.jar:lib/jung/vizualization.jar\" src/vue/*.java<br>$ java -cp \"build:lib/jung/algos.jar:lib/jung/api.jar:lib/jung/collections.jar:lib/jung/graph_api.jar:lib/jung/vizualization.jar\" vue.Demo
